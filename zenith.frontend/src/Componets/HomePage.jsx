      ...
      <div className=" dark:bg-gray-900 pt-4">
          ...
          <nav className="bg-grey text-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
              <Link to="/" className="flex items-center">
                <img src="/zenithlogo.png" className="h-6 mr-3 sm:h-9" alt="Logo" style={{width:"200px", height:"45px", padding:"0px", margin:"0px" }} />
              </Link>
          ...
          <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div className="mr-auto place-self-center lg:col-span-7">
              ...
              <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4 ">
                ...
                >
                  <h4 className=" transition ease-in-out delay-110 hover:scale-125 ">Try Courses</h4>
                </Link>
                <Link
                  to="/auth"
                ...
                >
                  ...
                  <h4 className="transition ease-in-out delay-110 hover:scale-125 ">Add Courses</h4>
                </Link>
              </div>
            </div>
        ...
        <section className="feature_cards dark:bg-gray-900">
          <div className="col-span-3 space-y-8 md:grid md:grid-cols-3 md:gap-12 md:space-y-0 flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            <div className="transition-all duration-300 border border-white hover:border-purple-600 rounded-2xl px-6 py-10 transition ease-in-out delay-110 hover:scale-105" style={{borderRadius:"15px"}}>
              <svg
            ...
            <div className="transition-all duration-300 border border-white hover:border-purple-600 rounded-2xl px-10 py-7 transition ease-in-out delay-110 hover:scale-105" style={{borderRadius:"15px"}}>
              <svg
                className="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500"
                fill="currentColor"
                viewBox="0 0 20 20"
            ...
            <div className="transition-all duration-300 border border-white hover:border-purple-600 rounded-2xl px-6 py-10 ease-in-out delay-110 hover:scale-105" style={{borderRadius:"15px"}}>
              <svg
                className="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500"
                fill="currentColor"
                viewBox="0 0 20 20"
            ...
            <div className="duration-300 border border-white hover:border-purple-600 rounded-2xl px-6 py-10 transition ease-in-out delay-110 hover:scale-105" style={{borderRadius:"15px"}}>
              <svg
                className="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500"
                fill="currentColor"
                viewBox="0 0 20 20"
            ...
            <div className="transition-all duration-300 border border-white hover:border-purple-600 rounded-2xl px-6 py-10 ease-in-out delay-110 hover:scale-105" style={{borderRadius:"15px"}}>
              <svg
                className="w-10 h-10 mb-2 text-white-600 md:w-12 md:h-12 dark:text-purple-500 bg-white"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
        ...
        <VerticalTimeline>
          {timeline.map((t, i) => {
            ...
            return (
              <VerticalTimelineElement
                key={i}
                className="vertical-timeline-element--work transition ease-in-out delay-110 hover:scale-105"
                contentStyle={{
